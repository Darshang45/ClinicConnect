import { FiCalendar, FiHeart, FiHelpCircle, FiMessageCircle, FiUpload, FiUserPlus, FiVideo } from "react-icons/fi";
import Card from "../../../components/common/Card";
import "../../../styles/patient_dashboard.css";

const quickActions = [{ label: "Book Appointment", icon: FiCalendar }, { label: "Find Doctor", icon: FiUserPlus }, { label: "Chat with Doctors", icon: FiMessageCircle }, { label: "Upload Report", icon: FiUpload }];
