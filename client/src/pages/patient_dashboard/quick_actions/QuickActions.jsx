...
const quickActions = [{ label: "Book Appointment", icon: FiCalendar, path: "/patient/book" }, { label: "Find Doctor", icon: FiUserPlus, path: "/patient/doctors" }, { label: "Video Consultation", icon: FiVideo }, { label: "Upload Report", icon: FiUpload }];
